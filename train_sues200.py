...
if __name__ == '__main__':
    ...
    print(f"\nsro Loss:")
    print(f"  weight: {config.weight_feature_align}")
    print(f"  weigh of FAF: {config.feat_align_weight_FAF}")
    print(f"  weight of cls: {config.feat_align_weight_cls}")
    print(f"  weight of ConvNeXt: {config.feat_align_weight_convnext}")
    print("=" * 70 + "\n")
